//=============================================================================
//
// File:         rwt/rwserve-nodemailer/src/rwserve-nodemailer.class.js
...
//               Incoming payload should have one key-value pair: mailTo=customer@other-example.com
...
//                    "response"                 // the last communication from the SMTP server with response code
...
/*
	plugins {
		rwserve-nodemailer {
			location `/palau/app/rwserve-nodemailer/dbg/rwserve-nodemailer.class.js`
			config {
				transport {
...
module.exports = class RwserveNodemailer {
	...
	async startup() {
		log.debug('RwserveNodemailer', 'v1.0.0; Joe Honton © 2018; CC0 1.0 Universal'); 
